                            ...
                            <tbody>
                                ...
                                <tr id="<?php echo $valor->id_empresa; ?>">
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="javascript:void(0)" data-href="<?php echo base_url('empresa'); ?>/deletar/<?php echo $valor->id_empresa; ?>" data-registro="<?php echo $valor->id_empresa;?>" data-tabela="empresa" class="deletar_registro"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                               <?php } ?>
                            </tbody>
