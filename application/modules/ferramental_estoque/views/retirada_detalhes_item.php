                    ...
                    <form action="<?php echo base_url('ferramental_retirada/liberar_retirada'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table--no-card table-responsive-md table-borderless table-striped table-earning" id="lista7">
                                    <thead>
                                        <tr class="active">
                                    ...
                                    <tbody>
                                        <?php foreach ($items as $item) { ?>
                                            <tr>
                                                ...
                                                <?php if ($retirada->status == 1) { ?>
                                                    <td>
                                                        <a class="confirmar_registro" data-tabela="<?php echo base_url("ferramental_estoque/detalhes/{$retirada->id_retirada}"); ?>" href="javascript:void(0)" data-registro="<?php echo $item->id_retirada_item; ?>" data-acao="Remover Item" data-redirect="true" data-href="<?php echo base_url("ferramental_estoque/remove_item/{$item->id_retirada_item}"); ?>">
                                ...
                                <table class="table table--no-card table-responsive-md table-borderless table-striped table-earning" id="lista8">
                                    <thead>
                                        <tr class="active">
                                    ...
                                    <tbody>
                                        <?php foreach ($ativos as $ativo) { ?>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-danger"><?php echo $ativo->codigo; ?></td>
