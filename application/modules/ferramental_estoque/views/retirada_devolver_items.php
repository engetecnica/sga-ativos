...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="<?php echo base_url('ferramental_estoque/devolver_items_retirada_salvar'); ?>" method="post" enctype="multipart/form-data" class="confirm-submit" data-acao="Devolver" data-icon="success" data-message="false" data-title="Devolver Itens" data-redirect="true" data-text="Clique 'Sim, Devolver!' para confirmar a devolução dos itens retirados.">
                                ...
                                <table class="table table--no-card table-responsive-md table-borderless table-striped table-earning">
                                    <thead>
                                        <tr class="active">
                                            ...
                                            <th scope="col" width="10%">Patrimônio</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($ativos as $ativo) { ?>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-danger"><?php echo $ativo->codigo; ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <select <?php echo (isset($no_aceite) && $no_aceite == true) ? 'disabled' : ''; ?> class="form-control select2" name="status_<?php echo $ativo->id_retirada_item; ?>[]" id="status_<?php echo $ativo->id_retirada_item; ?>[]" required="required">
