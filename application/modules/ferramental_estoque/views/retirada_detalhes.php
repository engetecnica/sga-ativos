                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ferramental_requisicao_detalhes">
                                                ...
                                                <?php if ($retirada->status == 1) {  ?>
                                                    ...
                                                    <a class="dropdown-item btn confirmar_registro" data-tabela="<?php echo base_url("ferramental_estoque/detalhes/{$retirada->id_retirada}"); ?>" href="javascript:void(0)" data-registro="<?php echo $retirada->id_retirada; ?>" data-acao="Liberar Retirada" data-redirect="true" data-href="<?php echo base_url("ferramental_estoque/liberar_retirada/{$retirada->id_retirada}"); ?>">
                                                ...
                                                <?php if (isset($retirada->termo_de_responsabilidade) && $retirada->status == 2) {  ?>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item btn confirmar_registro" href="javascript:void(0)" data-acao="Marcar" data-icon="info" data-message="false" data-title="Marcar como Entregues" data-redirect="true" data-text="Clique 'Sim, Marcar!' para confirmar o a entrega de todos os itens para o funcionário, não esquecendo de imprimir o Termo de Responsabilidade." data-href="<?php echo base_url("ferramental_estoque/entregar_items_retirada/{$retirada->id_retirada}"); ?>" data-tabela="<?php echo base_url("ferramental_estoque/detalhes/{$retirada->id_retirada}"); ?>">
                                                ...
                                                <?php if (isset($retirada->termo_de_responsabilidade) && $retirada->status == 4) {  ?>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item btn confirmar_registro" href="javascript:void(0)" data-acao="Devolver" data-icon="info" data-message="false" data-title="Devolver Retirada" data-redirect="true" data-text="Clique 'Sim, Devolver!' para confirmar a devolução dos itens por parte do funcionário, considerando que imprimiu e assinou o Termo de Responsabilidade corretamente como esperado." data-href="<?php echo base_url("ferramental_estoque/devolver_items_retirada/{$retirada->id_retirada}"); ?>">
                                                ...
                                                <?php if ($user->nivel == 1 && $retirada->status == 14) { ?>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item btn confirmar_registro" data-tabela="<?php echo base_url("ferramental_estoque/detalhes/{$retirada->id_retirada}"); ?>" href="javascript:void(0)" data-registro="<?php echo $retirada->id_retirada; ?>" data-acao="Autorizar Retirada" data-redirect="true" data-href="<?php echo base_url("ferramental_estoque/liberar_retirada/{$retirada->id_retirada}"); ?>">
                                                ...
                                                <?php if ($retirada->status == 1) { ?>
                                                    ...
                                                    <div class="dropdown-divider"></div> -->
                                                    <a class="dropdown-item btn confirmar_registro" data-tabela="<?php echo base_url("ferramental_estoque"); ?>" href="javascript:void(0)" data-registro="<?php echo $retirada->id_retirada; ?>" data-acao="Remover Retirada" data-redirect="true" data-href="<?php echo base_url("ferramental_estoque/remove_retirada/{$retirada->id_retirada}"); ?>">
                            ...
                            <?php if (!empty($retirada->items)) { ?>
                                ...
                                <table style="min-height: 180px;" class="table table--no-card table-responsive-md table-borderless table-striped table-earning" id="lista10">
                                    <thead>
                                        <tr class="active">
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url("ferramental_estoque/detalhes_item/{$item->id_retirada}/{$item->id_retirada_item}"); ?>">
                                                        ...
                                                        <?php if ($item->quantidade == 1) { ?>
                                                            <span class="badge badge-danger"><?php echo $item->codigo; ?></span>
                                                        <?php } ?>
                                                    </a>
                                                </td>
                                                <td>
