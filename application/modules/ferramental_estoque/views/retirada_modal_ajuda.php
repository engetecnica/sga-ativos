<div class="modal" tabindex="100" role="dialog" id="ajudaModal">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            <small class="m-t-30"><b>1</b> - <b>Detalhar Itens</b> essa ação consiste em mostrar uma lista detalhada dos itens 
            ...
            <small class="m-t-30"><b>2</b> - <b>Liberar Retirada</b> essa ação seleciona o itens e marca os mesmo como liberados** para a retirada,
            ...
            ** Em algumas situações quando para o funcionário existem retirada(s) pendente(s) de devolução, será solicitada a autorização de um administrador para a dar sequência ao processo,
            ...
            <small class="m-t-30"><b>3</b> - <b>Marcar como Entregues</b> essa ação marca os itens da retirada como entregues ao funcioário, 
            ...
            <small class="m-t-30"><b>4</b> - <b>Marcar como Devolvidos</b> essa ação marca os itens da retirada como devolvidos pelo funcioário, 
            ...
            <small class="m-t-30"><b>5</b> - <b>Editar</b> ou <b>Excluir</b> Como o nome sugere, edita ou exclui uma retirada, 
            ...
            <small class="m-t-30"><b>6</b> - <b>Imprimir Termo de Resp.</b> Como o nome sugere, faz download de um pdf contendo um Termo de Responsabilidade sobre os itens retirados. 
            ...
            <small class="m-t-30"><b>7</b> - <b>Ver Termo de Resp.</b> Como o nome sugere, vizualiza o Termo de Responsabilidade devidamente preechido e anexado.
            </small>
            <br> <br>

            <!-- <small class="m-t-30"><b>1</b> - Para <b>Liberar Requisição</b> ou <b>Recusar Requisição</b> dos itens solicitados, a mesma deve ter o status atual 
                <b class="badge badge-<?php echo $this->status_by_name('pendente')['class'];?>">Pendênte</b>.
            </small>
            <br> <br>
            <small class="m-t-30"><b>2</b> - Para <b>Enviar para Transferência</b> e confirmar a transferência dos itens solicitados ou **devolvidos, a mesma deve ter o status atual 
                ...
                ** Itens podem ser automaticamente devolvidos quando recebidos, porém marcados como 
                ...
                <b class="badge badge-<?php echo $this->status_by_name('comdefeito')['class'];?>">Com Defeito</b></small>
            <br> <br>
            <small class="m-t-30"><b>3</b> - <b>Receber Devoluções</b> , confirma a recepção de itens devolvidos ou com defeito oriundos de uma Requisição anteriormente realizada,
            a mesma deve ter o status atual <b class="badge badge-<?php echo $this->status_by_name('emtransito')['class'];?>">Em Trânsito</b>.</small>
            <br> <br>
            <small class="m-t-30"><b>4</b> - Para <b>Excluir</b> uma Requisição de itens, a mesma deve ter o status atual 
                <b class="badge badge-<?php echo $this->status_by_name('pendente')['class'];?>">Pendênte</b>
                e somente o usuário solicitante ou um administrador poderão executar essa ação.
            </small>
            <br> <br>
            <small class="m-t-30"><b>5</b> - Para **<b>Receber</b> itens de uma Requisição, a mesma deve ter o status atual 
