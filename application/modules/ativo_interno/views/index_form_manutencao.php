                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                      <div class="card-header">
                        ...
                        <div class="card-body">
                            <?php $no_permit_edit = isset($manutencao) && !$this->ativo_interno_model->permit_edit_manutencao($ativo->id_ativo_interno, $manutencao->id_manutencao); ?>
                            ...
                            <form action="<?php echo base_url("ativo_interno/manutencao_salvar"); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <?php if(isset($ativo) && isset($ativo->id_ativo_interno)){?>
                                  <input type="hidden" name="id_ativo_interno" id="id_ativo_interno" value="<?php echo $ativo->id_ativo_interno; ?>" <?php if ($no_permit_edit) echo "readonly"; ?> >
                                <?php } ?>
