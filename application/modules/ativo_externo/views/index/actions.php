        ...
        <div class="dropdown-menu" aria-labelledby="ativo_externo_item">
            ...
            <?php if ($this->permitido($permissoes, 11, 'editar')) { ?>
                ...
                <?php if ($row->situacao == 8 && ($self_obra)) { ?>
                    <a href="javascript:void(0)" data-href="<?php echo base_url('ativo_externo'); ?>/descartar/<?php echo $row->id_ativo_externo; ?>" redirect="true" data-tabela="ativo_externo" class="dropdown-item confirmar_registro"><i class="fa fa-ban"></i> Descartar</a>
                    <div class="dropdown-divider"></div>
                <?php } ?>
            ...
            <?php if ($this->permitido($permissoes, 11, 'excluir')) { ?>
                <?php if ($row->situacao == 12 && ($self_obra)) { ?>
                    <a href="javascript:void(0)" data-href="<?php echo base_url('ativo_externo'); ?>/deletar/<?php echo $row->id_ativo_externo; ?>" data-registro="<?php echo $row->id_ativo_externo; ?>" data-tabela="ativo_externo" class="dropdown-item  deletar_registro">
