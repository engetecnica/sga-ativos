    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="formObs" action="<?php echo base_url("ativo_externo/manutencao_obs_salvar/{$ativo->id_ativo_externo}/{$manutencao->id_manutencao}"); ?>" method="post" enctype="multipart/form-data">
