                  ...
                  <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a 
                                ...
                                data-href="<?php echo base_url("ativo_externo/manutencao_obs_remover/{$manutencao->id_manutencao}/{$valor->id_obs}"); ?>" 
                                data-registro="<?php echo $valor->id_obs;?>" 
                                data-tabela="ativo_externo/manutencao_editar/<?php echo "{$ativo->id_ativo_externo}/{$manutencao->id_manutencao}";?>" 
