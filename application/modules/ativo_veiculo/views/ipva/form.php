            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="overview-wrap">
                        ...
                        <a href="<?php echo base_url("ativo_veiculo/ipva/{$id_ativo_veiculo}"); ?>">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php 
                                $form_url = base_url("ativo_veiculo/ipva/{$id_ativo_veiculo}");
                                $form_url .= !isset($ipva) ? "" : "/{$ipva->id_ativo_veiculo_ipva}"; 
                            ?>
