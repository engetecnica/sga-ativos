            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="overview-wrap">
                        ...
                        <a href="<?php echo base_url("ativo_veiculo/seguro/{$id_ativo_veiculo}"); ?>">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <?php echo isset($seguro) && isset($seguro->id_ativo_veiculo_seguro) ? "Editar Registro de Seguro do Veículo" : "Novo Registro de Seguro do Veículo" ?>
                        </div>
                        <div class="card-body">
                            <?php 
                                $form_url = base_url("ativo_veiculo/seguro/{$id_ativo_veiculo}");
                                $form_url .= !isset($seguro) ? "" : "/{$seguro->id_ativo_veiculo_seguro}"; 
                            ?>
