            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="btn-group" role="group">
                        <button id="retiradas" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="zmdi zmdi-plus"></i> NOVA RETIRADA
                        </button>
                        <div class="dropdown-menu" aria-labelledby="retiradas">
                            <a class="dropdown-item" href="<?php echo base_url('ferramental_estoque/adicionar_manual'); ?>">
                                <i class="zmdi zmdi-search mr-5" aria-hidden="true"></i> Manual
                            </a>

                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo base_url('ferramental_estoque/adicionar'); ?>">
                                <i class="zmdi zmdi-refresh-alt " aria-hidden="true"></i> Automática
                            </a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="table table--no-card table-responsive table--no- m-b-40">
                        ...
                        <table class="table dataTable table-borderless table-striped table-earning" id="ferramental_estoque_index">
                        </table>
                    </div>
                </div>
            </div>
