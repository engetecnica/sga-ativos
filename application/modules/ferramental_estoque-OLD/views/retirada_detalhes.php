                                ...
                                <table style="min-height: 180px;" class="table table--no-card table-responsive-md table-borderless table-striped table-earning" id="lista">
                                    <thead>
                                        <tr class="active">
                                            ...
                                            <th width="7.5%" scope="col">Data da Devolucao</th>
                                            <th width="2.5%"scope="col">Situação</th>
                                            <th width="2.5%"scope="col">Renovado</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr  width="100%">
                                            ...
                                            <?php if(count($item->renovacao_pendente)>0){ ?>
                                                <button class="badge badge-sm badge-danger">pendente</button>
                                                <?php } ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="ferramental_requisicao_item_detalhes">
                                                        ...
                                                        <?php if($item->status == 9 && count($item->renovacao_pendente)==0){ ?>
                                                            <div class="dropdown-divider"></div>
                                                            <a
                                                                class="dropdown-item confirmar_renovacao"
                                                                href="javascript:void(0)"
                                                                data-acao="Renovar" data-icon="info" data-message="false"
                                                                data-title="Renovar Item" data-redirect="true"
                                                                data-text="Clique 'Sim, Renovar!' para confirmar a renovação do item <?php echo $item->nome; ?>. Selecione a data: "
                                                                url-post="<?php echo base_url("ferramental_estoque/renovar_items_retirada/{$retirada->id_retirada}/{$item->id_retirada_item}");?>"
                                                            >
                                                                <i class="fas fa-clone 4x"></i>&nbsp;Renovar Item
                                                            </a> 
                                                        <?php } ?>
                                                    </div>
                                                </div>
