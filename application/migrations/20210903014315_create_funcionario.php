...
class Migration_Create_Funcionario extends CI_Migration {
	...
	public function up(){
		if (!$this->db->table_exists($this->table)) {
			...
			->add_field('id_empresa int(11) DEFAULT NULL')
			...
			->add_field('email varchar(255) NOT NULL')
			->add_field('telefone varchar(255) NOT NULL')
			->add_field('celular varchar(255) NOT NULL')
